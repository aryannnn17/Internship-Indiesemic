...
sx126x_status_t sx126x_hal_write(const void *context, const uint8_t *command, const uint16_t command_length, const uint8_t *data, const uint16_t data_length)
{
    sx126x_status_t ret = SX126X_STATUS_OK ;
...
sx126x_status_t sx126x_hal_read( const void *context, const uint8_t* command, const uint16_t command_length,uint8_t *data, const uint16_t data_length )
{
    sx126x_status_t ret = SX126X_STATUS_OK;
...
{
    sx126x_status_t ret = SX126X_STATUS_ERROR;
...
sx126x_status_t sx126x_hal_preset( const void* context )
{
    sx126x_status_t ret = SX126X_STATUS_ERROR;
